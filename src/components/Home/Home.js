        ...
        <div className="home__container">
          ...
          <div className="">
            <p className="home__description">
              ...
              and the places to find their ingredients or the places which
              serve them for making your next night in or out with your friends into a
              new and exciting adventure.</p>
              <p className="home__description">
              All while supporting local businesses you
